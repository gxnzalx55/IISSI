...
const bookRenderer={
    asCard : function(book){
        ...
        <div class="card-body text-center m-0 p-3">
            ...
            <a href="create_books.html?bookId=${book.bookId}" ><button  class="btn btn-secondary col mx-auto">Editar</button></a>
            
            <a href="delete_books.html?bookId=${book.bookId}"><button class="btn btn-danger" id="button-delete">Borrar concurso</button></a>
